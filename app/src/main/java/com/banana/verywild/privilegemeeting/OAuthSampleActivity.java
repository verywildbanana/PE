...
/**
 * Created by lineplus on 21/02/2018.
 */
...
public class OAuthSampleActivity extends Activity {
     ...
     * client 정보를 넣어준다.
     */
    private static String OAUTH_CLIENT_ID = "bJJAS6FNva4emFRXR68W";
    private static String OAUTH_CLIENT_SECRET = "YgC0Im9Zxt";
    private static String OAUTH_CLIENT_NAME = "verywildbanana-pe";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("lhd_read", "getKeyHash~~~" + getKeyHash(this));
    }
